...
public class DominoGraoh extends JPanel {
	...
	public DominoGraoh(String nom) {
		this.numéro=nom;
		switch (Domino.getDomaine1(nom)) { // Definis la couleur de la première moitié
		...
		switch (Domino.getDomaine2(nom)) { // Couleur de la deuxième moitié
	...
	public void paintComponent(Graphics g){ // Dessine le domino
		 ...
		 g.setFont(f);
		 g.drawString(Domino.getCouronne1(numéro), 275, 40);
		 g.drawString(Domino.getCouronne2(numéro), 40, 40);
